...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2026 at 01:41 PM
...
ALTER TABLE `accomplishment_report`
  ...
  ADD KEY `fk_report_activity` (`act_design_id`),
  ADD KEY `fk_report_gpb` (`gpb_id`),
...
--
ALTER TABLE `control_number`
  MODIFY `control_number_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `accomplishment_report`
  ADD CONSTRAINT `fk_report_activity` FOREIGN KEY (`act_design_id`) REFERENCES `activity_design` (`act_design_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_report_gpb` FOREIGN KEY (`gpb_id`) REFERENCES `gad_plan_budget` (`gpb_id`) ON DELETE SET NULL,
